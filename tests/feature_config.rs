...
#[test]
fn individually_specified_features() {
...
mod only_explicit_features {
    use super::CargoSemverChecks;

    #[test]
    fn only_explicit_features() {
        CargoSemverChecks::new(
    ...
    #[test]
    fn and_baseline_and_current_features() {
        CargoSemverChecks::new(
            "test_crates/function_feature_changed/new/",
            "test_crates/function_feature_changed/old/Cargo.toml",
        )
...
mod undefined_default_features {
    use super::CargoSemverChecks;
    #[test]
